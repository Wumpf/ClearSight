...
namespace ClearSight.Core
{
    ...
    /// <summary>
    /// Describes the types of events that the Log class sends.
    /// </summary>
    enum MessageTypes
    {
        BeginGroup = -2,        /// <summary>A logging group has been opened.</summary>
        EndGroup = -1,          /// <summary>A logging group has been closed.</summary>
        None = 0,               /// <summary>Can be used to disable all log message types.</summary>
        ErrorMsg = 1,           /// <summary>An error message.</summary>
        SeriousWarningMsg = 2,  /// <summary>A serious warning message.</summary>
        WarningMsg = 3,         /// <summary>A warning message.</summary>
